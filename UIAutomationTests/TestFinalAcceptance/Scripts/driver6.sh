...
#FL_APPBUNDLE_PATH=~/Library/Developer/Xcode/DerivedData/iFleksy-cnieacgsclhowuapljisvitxicyg/Build/Products/Beta-iphoneos
FL_APPBUNDLE_PATH=~/Library/Developer/Xcode/DerivedData/iFleksy-cnieacgsclhowuapljisvitxicyg/Build/Products/Release-iphoneos
#FL_APPNAME=FleksyDev.app
#FL_APPNAME=FleksyBETA.app
...
FL_TEST=Test_iFleksyFinalAcceptance.js
...
do
    echo TEST:  $COUNT
    echo $TESTER $FL_APPBUNDLE $FL_AUTOMATIONTEST_PATH/$FL_TEST_DIR/$FL_TEST ../Results/$FL_TEST_RESULTS_DIR  $2 $3 --verbose --timeout 45
