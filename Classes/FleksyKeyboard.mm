...
- (void) handleSettingsChanged:(NSNotification*) notification {
  ...
  FLEKSY_APP_SETTING_SHOW_TRACES               = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_SHOW_TRACES" fromSettings:settings] boolValue];
  FLEKSY_APP_SETTING_KEY_SNAP                  = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_KEY_SNAP" fromSettings:settings] boolValue];
  ...
  FLEKSY_APP_SETTING_TOUCH_HOME                = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_TOUCH_HOME" fromSettings:settings] boolValue];
  FLEKSY_APP_SETTING_DICTATE_MODE              = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_DICTATE_MODE" fromSettings:settings] boolValue];
  FLEKSY_APP_SETTING_USE_SYSTEM_AUTOCORRECTION = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_USE_SYSTEM_AUTOCORRECTION" fromSettings:settings] boolValue];
  FLEKSY_APP_SETTING_SHOW_SUGGESTIONS          = YES;
  FLEKSY_APP_SETTING_LIVE_SUGGESTIONS          = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_LIVE_SUGGESTIONS" fromSettings:settings] boolValue];
  ...
  FLEKSY_APP_SETTING_SPEAKING_RATE             = 1;//[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_SPEAKING_RATE" fromSettings:settings] floatValue];
  ...
  FLEKSY_APP_SETTING_SPACE_BUTTON              = NO; //[[VariousUtilities getSettingNamed:@"FLEKSY_APP_SETTING_SPACE_BUTTON" fromSettings:settings] boolValue];
  ...
  FLEKSY_APP_SETTING_SAVE_TEXT_BUFFER          = YES; // ALWAYS ON
